...
for epoch in range(num_epochs):
    ...
    for images, labels in train_loader:
        ...
        if iterno % 10 == 0: # evaluate test accuracy after each 10 iterations
...
_ = plt.hist(exp_max_pred_prob_svhn, bins=100, range=(0, 1), weights=weights_svhn, alpha=0.5, label='SVHN')
